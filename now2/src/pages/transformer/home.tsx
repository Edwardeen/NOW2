  ...
  return (
    <div className="flex flex-col justify-center bg-Green">
      ...
      <div className='justify-center my-2 mx-10'>
        <span className='flex flex-col my-auto text-Tertiary font-extrabold text-4xl'>Transformers</span>
        
        <div className="grid grid-cols-4 w-full gap-5">
        {data.filter((item) => (item.transactionDeposited === true && item.transactionScreened)).map((item) => (
